...
P 100.0% [100.0% to 100.0%] (percentile)   R 98.8% [97.3% to 99.6%]   F1 99.4% [98.6% to 99.8%]
...
## src/hooks/use-window-size.ts  (tp 5, fp 0, fn 1, unscored 2)
  - useWindowSize -> onResize
  ~ useWindowSize -> useEffect
  ~ useWindowSize -> useState

## src/render-node-to-output.ts  (tp 26, fp 0, fn 1, unscored 3)
  - renderNodeToScreenReaderOutput -> Boolean
