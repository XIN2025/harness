...
## lib/box/index.ts  (tp 68, fp 0, fn 0, unscored 27)
  ~ __module__ -> Pattern
...
## lib/extend/console.ts  (tp 3, fp 0, fn 0, unscored 4)
  ~ register -> abbrev
  ~ register -> keys
  ~ register -> method
  ~ register -> promisify

## lib/extend/deployer.ts  (tp 1, fp 0, fn 0, unscored 2)
  ~ register -> method
  ~ register -> promisify

## lib/extend/generator.ts  (tp 1, fp 0, fn 0, unscored 2)
  ~ register -> method
  ~ register -> promisify
...
## lib/extend/renderer.ts  (tp 8, fp 0, fn 0, unscored 5)
  ~ getExtname -> extname
...
## lib/hexo/render.ts  (tp 28, fp 0, fn 0, unscored 7)
  ~ getExtname -> extname
  ~ render -> readFile
  ~ render -> reject
  ~ render -> resolve
...
## lib/plugins/console/list/page.ts  (tp 5, fp 0, fn 0, unscored 5)
  ~ listPage -> gray
  ~ listPage -> log
  ~ listPage -> magenta
  ~ listPage -> table
...
## lib/plugins/filter/after_render/external_link.ts  (tp 5, fp 0, fn 0, unscored 1)
...
## lib/plugins/filter/template_locals/i18n.ts  (tp 8, fp 0, fn 0, unscored 1)
...
## lib/plugins/helper/list_tags.ts  (tp 7, fp 0, fn 0, unscored 3)
  ~ listTagsHelper -> call
...
## lib/plugins/helper/open_graph.ts  (tp 21, fp 0, fn 0, unscored 14)
  ~ __module__ -> includes
  ~ __module__ -> shallow
  ~ __module__ -> split
...
## lib/plugins/helper/tagcloud.ts  (tp 17, fp 0, fn 0, unscored 4)
...
## lib/theme/index.ts  (tp 9, fp 0, fn 0, unscored 6)
  ~ constructor -> I18n
  ~ constructor -> isArray
  ~ getView -> extname
  ~ getView -> keys
